...
function SearchForm(props) {
    ...
    const jobOptions = ['Java Developer','Javascript Developer','React Developer','Frontend Developer','Devops Engineer']
    const locationOptions = ['San Fransico','San Jose','New York','Seattle','Florida'];
